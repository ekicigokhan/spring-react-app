...
public class FileTypeValidator implements ConstraintValidator<FileType, String> {
    ...
    String[] types; //configure ettiğimiz değerleri eklemiş olduk.
    ...
    public boolean isValid(String value, ConstraintValidatorContext context) {
        ...
        String validTypes = Arrays.stream(types).collect(Collectors.joining(", ")); // jpeg, png gibi olacak.
        ...
        hibernateConstraintValidatorContext.addMessageParameter("types", validTypes); //replace işlemi
